# RPG / Game Simulation Projects (Umbrella)
...
A home for smaller game-mechanics experiments and simulations that don't warrant their own full repository.
...
1. Phase 1: 2D RPG prototype with basic movement/combat
2. Phase 2: Survival stat systems (hunger/thirst/stamina)
3. Phase 3: Roulette physics simulation
4. Phase 4: Procedural mechanics experiments

## 6. Repository Structure

```text
python-game-simulations/
├── README.md
├── LICENSE
├── .gitignore
├── pyproject.toml
...
```bash
docker build -t python-game-simulations .
docker run -p 8000:8000 python-game-simulations
```
